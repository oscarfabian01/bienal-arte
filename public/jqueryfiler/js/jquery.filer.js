...
(function($) {
    ...
    $.fn.filer.defaults = {
        ...
        captions: {
            ...
            feedback: "Elige los archivos a cargar",
            feedback2: "Archivos elegidos",
            drop: "Drop file here to Upload",
            removeConfirmation: "Esta seguro de remover el archivo?",
            errors: {
                filesLimit: "Solo son permitidos {{fi-limit}} archivos.",
                filesType: "Solo son permitidas imagenes.",
                filesSize: "{{fi-name}} ¡Es demasiado largo! Cargue archivos de hasta {{fi-fileMaxSize}} MB.",
                filesSizeAll: "¡Los archivos elegidos son demasiado grandes! Cargue archivos hasta de {{fi-maxSize}} MB.",
                folderUpload: "No se permiten cargar directorios."
            }
        }
    }
})(jQuery);
